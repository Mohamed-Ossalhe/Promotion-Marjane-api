...
import ma.youcode.services.PromotionService;
...
public class PromotionController {
    ...
    public ResponseEntity<Promotion> createPromotion(@RequestBody Promotion promotion) {
        Optional<Promotion> existingPromotion = promotionService.getPromotionByPercentage(promotion.getPercentage());
        if (existingPromotion.isPresent())
            return new ResponseEntity<>(existingPromotion.get(), HttpStatus.OK);
